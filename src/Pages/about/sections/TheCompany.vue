      ...
      <div class="w-full md:w-1/2 px-4  my-20">
        <div class="md:mx-20">
          <div class="w-full p-0 ">
            <div class="flex flex-wrap sm:justify-start justify-center ">
              ...
              <p
                class="top-content uppercase text-green-500 font-bold text-lg py-6"
              >
                About the Network
              </p>
            </div>
            <h2
              class="uppercase md:leading-tight title text-4xl font-black text-white mt-1.5 "
            >
        ...
        <div class="flex-wrap flex md:ml-20 ">
          <div class="md:w-1/2 w-full py-8">
            <h4
              class="text-2xl text-white font-semibold flex items-center justify-center sm:justify-start"
            >
              <div>
                <svg
            ...
            <p class="text-gray-400 pt-4 text-xl text-center">
         ...
         <div class="mx-20">
                        ...
                        <div class="flex-wrap flex mx-20 ">
                            <div class="md:w-1/2 w-full py-8">
                                ...
                                <p class="text-gray-400 pt-4 text-xl text-center">Lorem ipsum dolor sit amet consectetur adipiscing elit.</p>
                            </div>
                            <div class="md:w-1/2 w-full  py-8">
                                <h4 class="text-2xl text-white font-semibold flex items-center justify-center sm:justify-start">
                                    <div>
